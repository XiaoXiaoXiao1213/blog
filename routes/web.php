...
//首页分类  二维数组  大分类是键名
Route::get('/classification','ClassiController@classification');

//新品  传入的是类型 没传入数据默认第一个
Route::get('/newgoods','ClassiController@newGoods');

//首页最下面那个   传入1 2 3 4
Route::get('/thech','ClassiController@thech');
...
//商品详情下面那个表  传入的是商品名称
Route::get('/goodss','GoodsController@goodsdetail');
